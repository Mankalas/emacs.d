...
(customize-set-value 'feature-cucumber-command "PS_MARKET={market} bundle exec cucumber {feature}{options}")
...
(defun powershop-feature-verify-all-scenarios-in-buffer (market)
  ...
  (feature-run-cucumber "BROWSER=chrome" market :feature-file (buffer-file-name)))
